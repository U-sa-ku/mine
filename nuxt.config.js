...
export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Barlow:wght@100;300&display=swap&text=ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.' }
    ]
  },
  ...
  plugins: [
    ...
    { src: '~/plugins/throttle-requests.js', mode: 'client' }
  ],
